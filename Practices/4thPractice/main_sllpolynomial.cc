...
int main()
{
  ...
  double c1, c2, c3;
  int i1, i2, i3;
  // Hardcoded, but could be read from the input
  c1 = 2.0;
  i1 = 2;
  c2 = 3.0;
  i2 = 3;
  c3 = 4.0;
  i3 = 4;
  cout << "sllp2.WeirdSum(" << c2 << ", " << i2 << ")= " << sllp2.WeirdSum(c2, i2) << endl;
  cout << "sllp1.WeirdSum(" << c1 << ", " << i1 << ")= " << sllp1.WeirdSum(c1, i1) << endl;
  cout << "sllp3.WeirdSum(" << c3 << ", " << i3 << ")= " << sllp3.WeirdSum(c3, i3) << endl;
  cout << endl;
